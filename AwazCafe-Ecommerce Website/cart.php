...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="table-responsive cart_info" style="border: 100% ;">
					...
					<tbody style="border: 100% ;">
						<?php
							if(!empty($_SESSION["shopping_cart"]))
							{
								...
								{
							?>
							<td class="cart_product" style="border: 100% ;">
								<a href=""><img style="border: 100% ;" src="images/home/<?php echo $values["item_image"]; ?>" alt=""></a>
							</td>
